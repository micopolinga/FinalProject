...
class DancerController extends Controller
{
    ...
    public function delete(Dancer $dancer)
    {
        ...
        $dancerName = $dancer->full_name; // Assuming 'full_name' is a property of your Dancer model
        $dancer->delete();

        // Redirect with success message
        return redirect()->route('dancer')->with('message', "$dancerName has been deleted successfully");
    }
}
