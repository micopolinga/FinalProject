...
class EventController extends Controller
{
    ...
    public function delete(Event $event)
    {
        ...
        $eventName = $event->event_name; // Assuming 'event_name' is a property of your Event model
        $event->delete();
    
        // Redirect with success message
        return redirect()->route('event')->with('message', "$eventName has been deleted successfully");
    }
