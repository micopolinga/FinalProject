...
<div class="row">
    ...
    <div class="col-md-4 mx-auto" style="border: 1px solid">
        <h1 style="color: rgb(255, 255, 255)">EDIT STYLE</h1>
        <form action="{{url('/style/'.$style->id)}}" method="POST">
            ...
            <div class="form-group mt-2">
                <label for="name" style="color: white">STYLE NAME</label>
            ...
            <div class="form-group mt-2">
                <label for="descriptopn" style="color: white">Description</label>
            ...
            <div class="form-group mt-2">
                <label for="origin" style="color: white">Origin</label>
